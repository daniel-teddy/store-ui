...
import ProductsPageSmallRaspberry from '../components/RaspberryShop';
// import backgroundpattern from '../images/background-pattern.jpg'
// import ProductsPageSmallSolar from '../components/SolarShop';

function ShopRaspberryPage() {
  useEffect(() => {
  ...
  return (
    ...
    <ProductsPageSmallRaspberry />
    <ApplyDiscount />
    </>
  )
}

export default ShopRaspberryPage;
    ...
    <div className="container-fluid">
      <div className="row row-cols-1 row-cols-sm-3 row-cols-lg-5">
        <FeatureCard
          ...
          title="Free delivery"
          text="Get your parcel without any hasle from +1000 TL order"
        />
        <FeatureCard
          icon={
          ...
          text="Your payment details are secured via Secure Sockets Layer (SSL) encryption"
        />
        <FeatureCard
          icon={
        ...
        <FeatureCard
          ...
          text="Get all of your items with discount and very competitive prices"
        />
        <FeatureCard
          icon={
          ...
          title="Daily offers"
          text="Connect everyday to get your hands on daily offers"
        />
